			...
			<div id="its_cnf">
				...
				<div>
					...
					<div id="cnf" class="box box_row box_one">
						<p class="component">
							<a name="CNF"></a>
                            <a href="/releases/CNF/latest/index" target="_blank"><b>CNF</b><br>(Conformance)</a><br>
					...
					<div id="its" class="box box_row box_one">
						<p class="component">
                            <a name="ITS"></a>
                            <a href="/releases/ITS/latest/index" target="_blank"><b>ITS</b><br>(Implementation Technologies)</a><br>
						...
						<p class="specs">
                            <a href="/releases/ITS-REST/latest/ehr.html" target="_blank"><b>EHR</b></a>, <br>
                            <a href="/releases/ITS-REST/latest/query.html" target="_blank"><b>Query</b></a>, <br>
                            <a href="/releases/ITS-REST/latest/definitions.html" target="_blank"><b>Definitions</b></a><br>
                            <a href="/releases/ITS-REST/latest/simplified_data_template.html" target="_blank"><b>SDT</b></a>: Simplified Data Template<br>
                            <a href="https://github.com/openEHR/specifications-ITS-XML" target="_blank"><b>XSDs</b></a>: XML Schemas for the openEHR RM and AM<br>
                            <a href="https://github.com/openEHR/specifications-ITS-JSON" target="_blank"><b>JSON schema</b></a>: JSON Schemas for the openEHR RM and AM<br>
			...
			<div id="content_process">
				...
				<div>
					...
					<div id="proc" class="box box_row box_one">
						...
						<p class="specs">
                            <a href="/releases/PROC/latest/task_planning.html" target="_blank"><b>Task Planning (TP)</b></a>: An adaptive, executable, team-based model of workflow - Work Plan, Task Plan, Event<br>
                            <a href="/releases/PROC/latest/tp_vml.html" target="_blank"><b>TP Visual Modelling Language (TP-VML)</b></a>:<br>A visual modelling language for clinical plans and workflows.<br>
					...
					<div id="rm" class="box box_row box_one">
						<p class="component">
                            <a name="RM"></a><a href="/releases/RM/latest/index" target="_blank"><b>RM</b><br>(Reference Model)</a><br>
						...
						<p class="specs">
                            <a href="/releases/RM/latest/demographic.html" target="_blank"><b>Demographic</b></a>: Party, Party_relationship, Actor, Role, Contact, Address<br>
                            <a href="/releases/RM/latest/ehr.html" target="_blank"><b>EHR</b></a>: Composition, Section, Entry, Observation, Evaluation, Instruction, Action, Admin_entry<br>
                            <a href="/releases/RM/latest/ehr_extract.html" target="_blank"><b>EHR Extract</b></a>: OpenehrExtract, GenericExtract<br>
                            <a href="/releases/RM/latest/common.html" target="_blank"><b>Common</b></a>: Versioned_object, Version, Party_self, Audit_details<br>
                            <a href="/releases/RM/latest/integration.html" target="_blank"><b>Integration</b></a>: IntegrationEntry<br>
							<a href="/releases/RM/latest/data_structures.html" target="_blank"><b>Data Structures</b></a>: History, Event, ItemTree, Cluster, Element<br>
                            <a href="/releases/RM/latest/data_types.html" target="_blank"><b>Data Types</b></a>: DvBoolean, DvText, DvCodedText, DvUri, DvQuantity, DvDate/Time types, DvMultimedia<br>
                            <a href="/releases/RM/latest/support.html" target="_blank"><b>Support</b></a>: Terminology and Measurement service interfaces
						</p>
						<p class="releases">
					...
					<div id="term" class="box box_row box_one">
						<p class="component">
                            <a name="TERM"></a><a href="/releases/TERM/latest/index" target="_blank"><b>TERM</b><br>(Terminology)</a><br>
						...
						<p class="specs">
                            <a href="/releases/TERM/latest/SupportTerminology.html" target="_blank"><b>openEHR Terminology</b></a>:
			...
			<div id="formalisms">
				...
				<div>
					...
					<div id="query" class="box box_row box_one">
						<p class="component">
                            <a name="QUERY"></a><a href="/releases/QUERY/latest/index" target="_blank"><b>QUERY</b><br>(Query language)</a><br>
					...
					<div id="am" class="box box_row box_one">
						<p class="component">
                            <a name="AM"></a><a href="/releases/AM/latest/index" target="_blank"><b>AM</b><br>(Archetype Model)</a><br>
						...
						<p class="specs">
							<a href="" target="_blank"><b>OPT 1.4</b></a>: Operational Template 1.4<br>
                            <a href="/releases/AM/latest/OPT2.html" target="_blank"><b>OPT 2</b></a>: Operational Template 2<br>
                            <a href="/releases/AM/latest/ADL1.4.html" target="_blank"><b>ADL 1.4</b></a>: Archetype Definition Language 1.4<br>
                            <a href="/releases/AM/latest/ADL2.html" target="_blank"><b>ADL 2</b></a>: Archetype Definition Language 2<br>
                            <a href="/releases/AM/latest/AOM1.4.html" target="_blank"><b>AOM 1.4</b></a>: Archetype, CObject, ArchetypeSlot, CAttribute, CPrimitive<br>
                            <a href="/releases/AM/latest/AOM2.html" target="_blank"><b>AOM 2</b></a>: Archetype, AuthoredArchetype,Template, OperationalTemplate, CObject, ArchetypeSlot, CAttribute, CPrimitive<br>
                            <a href="/releases/AM/latest/Identification.html" target="_blank"><b>Identification</b></a>: archetype / template identifiers; versioning rules
						</p>
						<p class="releases">
					...
					<div id="lang" class="box box_row box_one">
						<p class="component">
                            <a name="LANG"></a><a href="/releases/LANG/latest/index" target="_blank"><b>LANG</b><br>(Generic Languages)</a><br>
						...
						<p class="specs">
                            <a href="/releases/LANG/latest/expression_language.html" target="_blank"><b>Expression Language</b></a>: a syntax for formal expressions<br>
                            <a href="/releases/LANG/latest/bmm.html" target="_blank"><b>BMM</b></a>: Basic Meta-Model - BmmSchema, BmmModel, BmmClass, BmmType, BmmProperty<br>
                            <a href="/releases/LANG/latest/bmm_persistence.html" target="_blank"><b>P_BMM</b></a>: BMM Human-readable serial format - PBmmSchema, P_xxx types<br>
			...
			<div id="foundations">
				...
				<div>
					...
					<div id="base" class="box box_row box_one">
						<p class="component">
                            <a name="BASE"></a>
                            <a href="/releases/BASE/latest/index" target="_blank"><b>BASE</b><br>(Base models)</a><br>
						...
						<p class="specs">
                            <a href="/releases/BASE/latest/base_types.html" target="_blank"><b>Base Types</b></a>: Identifiers<br>
                            <a href="/releases/BASE/latest/resource.html" target="_blank"><b>Resource</b></a>: AuthoredResource<br>
