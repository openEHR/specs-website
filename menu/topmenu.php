    <ul id="menu" class="menu">
        ...
        <li>Specs Platform
            <ul>
                ...
                <li><a href="/components/SM/open_issues" target="_blank">PRs</a></li>
                <li><a href="https://openehr.atlassian.net/projects/SPECSM?orderField=RANK&selectedItem=com.atlassian.jira.jira-projects-plugin%3Arelease-page&status=released-unreleased" target="_blank">CRs</a></li>
            </ul>
        </li>
        ...
        <li>Specs Process
            <ul>
                ...
                <li><a href="/components/PROC/open_issues" target="_blank">PRs</a></li>
                <li><a href="https://openehr.atlassian.net/projects/SPECPROC?orderField=RANK&selectedItem=com.atlassian.jira.jira-projects-plugin%3Arelease-page&status=released-unreleased" target="_blank">CRs</a></li>
            </ul>
        </li>
        ...
        <li>Specs Formalisms
            <ul>
                ...
                <li><a href="/components/LANG/open_issues" target="_blank">PRs</a></li>
                <li><a href="https://openehr.atlassian.net/projects/SPECLANG?orderField=RANK&selectedItem=com.atlassian.jira.jira-projects-plugin%3Arelease-page&status=released-unreleased" target="_blank">CRs</a></li>
            </ul>
        </li>
        ...
        <li>Specs Foundations
            <ul>
                ...
                <li><a href="/components/BASE/open_issues" target="_blank">PRs</a></li>
                <li><a href="https://openehr.atlassian.net/projects/SPECBASE?orderField=RANK&selectedItem=com.atlassian.jira.jira-projects-plugin%3Arelease-page&status=released-unreleased" target="_blank">CRs</a></li>
            </ul>
        </li>
